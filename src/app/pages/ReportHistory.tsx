...
<<<<<<< HEAD
              ...
              <div className="pt-4 mt-4 border-t border-gray-100 flex gap-3">
                ...
                <button onClick={() => {
                  ...
                  link.href = `http://localhost:3001${selectedReport.file_path}`;
                  link.download = selectedReport.name || 'report.pdf';
                  link.target = '_blank';
                  link.click();
                }}
                  className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-gray-50 text-gray-700 text-sm font-semibold hover:bg-gray-100 transition-colors border border-gray-200">
